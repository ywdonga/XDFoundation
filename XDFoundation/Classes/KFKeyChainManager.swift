//
//  KFKeyChainManager.swift
//  KfangFoundation
//
//  Created by miao on 2022/6/20.
//

import UIKit

public class KFKeyChainManager: NSObject {
    /// 创建查询条件
...
//
            ...
            let temp = Data(referencing: data)
            idObject = NSKeyedUnarchiver.unarchiveObject(with: temp) as Any
        }
        return idObject as Any
    }
    ...
    /// 删除数据
    public class func keyChianDelete(identifier: String) {
        // 获取删除的条件
